...
class EmbeddingEMA(nn.Module):
    def __init__(self, num_tokens, codebook_dim, decay=0.99, eps=1e-5, 
                 kmeans_init=True, codebook_init_path='', ema=True):
        super().__init__()
...
class NormEMAVectorQuantizer(nn.Module):
    def __init__(self, n_embed, embedding_dim, commitment_loss_weight, decay=0.99, eps=1e-5,
        ...
        self.embedding = EmbeddingEMA(self.num_tokens, self.codebook_dim, decay, eps, kmeans_init, codebook_init_path, ema)
    ...
    def forward(self, z):
        ...
        if self.training and self.embedding.ema:
            # EMA cluster size
