...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, stride=10, in_chans=3,
                 ...
                 use_custom_patch=False, pos_trainable=False, decoder_mode=0,
                 mask_t_prob=0.6, mask_f_prob=0.5, mask_2d=False,
                 code_num=1024, codebook_set=1,
                 no_shift=False,
                 ):
        super().__init__()
            ...
            for index in range(16):
                ...
                decoder_modules.append(
                    SwinTransformerBlock(
                        ...
                        feedforward_dim=mlp_ratio * decoder_embed_dim,
                    )
                )
        ...
        self.decoder_pred = nn.Linear(decoder_embed_dim, code_num * codebook_set, bias=True) # decoder to patch
    ...
    def forward(self, imgs, mask_ratio=0.8, encoder_training=True):
        if encoder_training:
            emb_enc, mask, ids_restore = self.forward_encoder(imgs, mask_ratio, mask_2d=self.mask_2d)
...
vit_b = mae_vit_base_patch16
vit_l = mae_vit_large_patch16
vit_s = mae_vit_small_patch16
